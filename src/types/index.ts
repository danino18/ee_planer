...
export interface SpecializationGroupYearVariant {
  ...
  additionalElectiveCourses?: SpecializationCourseReference[];  // adds new elective options to the group's pool for this year
}
...
export interface StudentPlan {
  ...
  manualMelagCourseIds?: string[];  // course IDs student marked as counting toward מל"ג
