...
function PlannerApp({ courses, trackDef, availableYears }: { courses: Map<string, SapCourse>; trackDef: TrackDefinition; availableYears: number[] }) {
  ...
  const mobileSidebarOpen = useOnboardingStore((s) => s.mobileSidebarOpen);
  ...
  return (
    ...
    <div className="app-bg">
      ...
      <header className="app-header sticky top-0 z-10" data-tour="header">
        <div className="max-w-screen-2xl mx-auto px-5 py-3.5 flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2 justify-end">
              ...
              <button
                data-tour="degree-completion-btn"
      ...
      <main className="max-w-screen-2xl mx-auto px-3 sm:px-4 py-5 md:py-6">
        <div className="flex flex-col md:flex-row md:gap-5">
          ...
          <MobileSidebarDrawer open={sidebarOpen || mobileSidebarOpen} onClose={() => setSidebarOpen(false)}>
            <div data-tour="requirements-panel">
              <RequirementsPanel progress={progress} weightedAverage={weightedAverage} courses={courses} />
            </div>
            <div data-tour="specialization-panel">
...
function AppInner() {
  ...
  useEffect(() => {
    ...
    if (shareMode || authLoading || loading || error) return;
    if (hasCompletedOnboarding) return;
    onboardingStartedRef.current = true;
    startOnboarding();
  }, [shareMode, authLoading, loading, error, hasCompletedOnboarding, startOnboarding]);
  ...
  return (
    <>
      {tour}
      <PlannerApp courses={courses} trackDef={resolvedTrackDef} availableYears={availableYears} />
    </>
  );
}
